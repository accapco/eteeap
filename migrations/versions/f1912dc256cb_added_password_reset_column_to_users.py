"""Added password reset column to users

Revision ID: f1912dc256cb
Revises: 26b872bdf606
Create Date: 2024-06-02 00:56:45.850120
...
revision = 'f1912dc256cb'
down_revision = '26b872bdf606'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.alter_column('residency',
               existing_type=sa.TEXT(length=7),
