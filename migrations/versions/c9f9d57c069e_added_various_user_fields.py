...
Revision ID: c9f9d57c069e
Revises: 072128939aa7
Create Date: 2024-06-05 11:40:49.124434
...
revision = 'c9f9d57c069e'
down_revision = '072128939aa7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('admin', schema=None) as batch_op:
        batch_op.add_column(sa.Column('director', sa.Boolean(), nullable=True))
